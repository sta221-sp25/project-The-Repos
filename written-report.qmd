...
Given that the condition we established for the "high probability" (i.e. total score greater than 6) allows the logistic model to perfectly separate the response variable in the data into "high" and "low" probabiities (thus making the respecttive MLE for $\beta_j$ go to infinity), a penalized logistic regression model (LASSO) was employed
```{r, echo =FALSE}
complex_log_mod <- glm(highProb ~ small_sounds +
