...
For these purposes, both univariate and bivariate data analyses will be pursued as a means of assessing relevant avenues for further investigation and model fitting. We created a new variable indicating the proportion of high scores and otherwise relabeled the features representing questions in the data set with their actual wording for interpretability, in addition to representing "Yes" as a 1 and "No" as a 0 for their values. The exploratory data analysis of the demographic data and questions can be found in the following pages. \newpage
