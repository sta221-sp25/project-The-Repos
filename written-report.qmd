...
$$H_0: \beta_1 = 0$$
$$H_a: \beta_1 \neq 0$$
- Table 1: Drop-in-deviance test results comparing null model $log(\frac{\pi}{1-\pi})=\beta_0$ to single-predictor model $log(\frac{\pi}{1-\pi})=\beta_0 + \beta_1X_1$
```{r, echo = FALSE}
tribble(
