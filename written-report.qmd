...
$$Null:log(\frac{\hat\pi}{1-\hat\pi})=\beta_0$$
$$Alternative:log(\frac{\hat\pi}{1-\hat\pi})=\beta_0 + \beta_{predictor}x_{predictor}$$
...
```{r, echo=FALSE, message = FALSE, fig.cap = "Correlation between AQ10 questions"}
q1_to_10 <- autism_ds |>
